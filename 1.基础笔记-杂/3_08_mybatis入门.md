...
•__插入操作涉及数据库数据变化，所以要使用sqlSession对象显示的提交事务，即sqlSession.commit() __
...
•__Sql语句中使用#{任意字符串}方式引用传递的单个参数__
...
![](img/mybatis/MyBatis核心配置文件层级关系.png)
...
![](img/mybatis/environments标签.png)
...
实际开发中，习惯将数据源的配置信息单独抽取成一个properties文件，该标签可以加载额外配置的properties文件
  ...
  ![](img/mybatis/Properties标签.png)

**4)typeAliases标签**

类型别名是为Java 类型设置一个短的名字。原来的类型名称配置如下

![](img/mybatis/typeAliases标签.png)

配置typeAliases，为com.itheima.domain.User定义别名为user

![](img/mybatis/typeAliases标签2.png)

上面我们是自定义的别名，mybatis框架已经为我们设置好的一些常用的类型的别名

![](img/mybatis/typeAliases标签3.png)
...
![1552653723002](img/mybatis/工厂对象SqlSessionFactory.png)
